...
<section class="hero">
  <div class="hero-inner">
    <div class="hero-content ">
        ...
        <a href="<?php echo $videoEmbedLink; ?>"class="play-btn-container video-modal-button"><?php echo playBtn(); ?></a>
...
<section class="double-column-top" >
    ...
    <div
        class="pt-5 double-column-inner d-flex flex-column flex-lg-row justify-content-center align-items-center
         content-bounds">
        <div class="double-col-img-container" data-aos="fade-up">
            <img class="double-col-img" src="<?php echo $doubleColImg['url']; ?>" alt="<?php echo $doubleColImg['alt']; ?>" width="<?php echo $img['width']; ?>" height="<?php echo $img['height']; ?>">
        </div>
...
<section class="double-column-bottom">
    <div class="content-row double-column pt-5 pb-5">
    <div
        class="pt-3 double-column-inner d-flex flex-column flex-lg-row-reverse justify-content-center align-items-center
         content-bounds">
        <div class="double-col-img-container" data-aos="fade-up">
            <img class="double-col-img" src="<?php echo $doubleColImg2['url']; ?>" alt="<?php echo $doubleColImg2['alt']; ?>" width="<?php echo $img['width']; ?>" height="<?php echo $img['height']; ?>">
        </div>
        <div class="double-col-copy text-center justify-content-center align-items-center d-flex flex-column">
           <div class="double-col-copy-inner" data-aos="fade-up">
           <div class="double-col-title mb-3">
