      ...
      <div class="content-block blog-bounds blog-content">
        <?php if( have_rows('blog_content_rows') ): 
            ...
            <div class="image-container pt-3 pb-3">
              <img src="<?php echo esc_url($image['url']); ?>" alt="<?php echo esc_attr($image['alt']); ?> " width="<?php echo $img['width']; ?>" height="<?php echo $img['height']; ?>" />
            </div>
            <?php endif; ?>
            <?php
  ...
  <?php endwhile; ?>
  <button class="back-to-blog mt-3" onclick="history.back()"><span class="back-button">Back to Blog</span> <?php echo arrowRight()?></button>
</div>
<?php endif; ?>