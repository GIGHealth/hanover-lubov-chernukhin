  ...
  <div class="carousel-wrap position-relative" data-aos="fade-up" data-aos-delay="100">
    <div
      ...
      <div class="image-wrapper position-relative">
        <img
          class="image image-position-carousel image-position-<?php echo esc_html ( get_sub_field('image_position') ); ?>"
          src="<?php echo $img['url']; ?>" alt="<?php echo $img['alt']; ?>" width="<?php echo $img['width']; ?>"
